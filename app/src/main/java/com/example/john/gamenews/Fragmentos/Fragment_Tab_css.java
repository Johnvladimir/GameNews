...
public class Fragment_Tab_css extends Fragment {
    ...
    public Fragment_Tab_css() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static Fragment_Tab_css newInstance(String param1, String param2) {
        Fragment_Tab_css fragment = new Fragment_Tab_css();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_fragment__tab_css, container, false);
        ...
        if (Utilidades_Tab.rotacion == 0) {
            ...
            if (appBar == null) {
                ...
                viewPager = view.findViewById(R.id.viewPagerCss);
